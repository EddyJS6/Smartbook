...
const NOTE_COLUMNS =
  "user_id,id,book_id,title,formatted_content,extracted_text,personal_reflection,page_number,tags,source_type,created_at,updated_at,deleted_at,server_updated_at";
