...
Le schéma, RLS, le bucket privé et la création du compte personnel sont décrits
dans `SUPABASE_SETUP.md`. Ne jamais ajouter de clé `service_role` à Vercel.
...
2. Scanner une page puis appuyer sur **Envoyer**.
...
5. Passer brièvement en mode avion : BrainBook doit conserver la photo et
